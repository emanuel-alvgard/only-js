...
// @DONE
async function buffer_add(item, buffer) {
...
// @DONE
function buffer_remove(index, buffer) {
...
exports.buffer_create = buffer_create;
exports.buffer_add = buffer_add;
exports.buffer_remove = buffer_remove;
